    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked==true){
                    Intent intent =new Intent(new1.this,MainActivity.class);
                    startActivity(intent);
                    Toast.makeText(getBaseContext(),"2D mode is on",Toast.LENGTH_SHORT).show();
        ...
        b1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound1,2.0f,0.0f,0,0,0f);
        ...
        b2.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound2,3.0f,1.0f,0,0,0f);
        ...
        b3.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound3,0.0f,2.0f,0,0,0f);
        ...
        b4.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound4,2.0f,0.0f,0,0,0f);
        ...
        b5.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound5,3.0f,1.0f,0,0,0f);
        ...
        b6.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound6,0.0f,2.0f,0,0,0f);
        ...
        b7.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound7,2.0f,0.0f,0,0,0f);
        ...
        b8.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound8,3.0f,1.0f,0,0,0f);
        ...
        b9.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound9,0.0f,5.0f,0,0,0f);
        ...
        b10.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound10,2.0f,0.0f,0,0,0f);
        ...
        b11.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound11,3.0f,1.0f,0,0,0f);
        ...
        b12.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                soundPool.play(sound12,0.0f,0.0f,0,0,0f);
